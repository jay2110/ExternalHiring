...
public class ExternalHiringController {
	...
	@PostMapping(path = "/{requirement}")              //API to find the candidate externally      
	...
	@PostMapping(path = "/addCandidate")                          //API to save Candidate data for external-Hiring                        
	...
	@PostMapping(path = "/InternalRequest")                                  //API handling request from Internal-hiring controller to match candidate
